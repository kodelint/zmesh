...
# Oh My Yet Another Dotfile Repo v1.1
# Now with Prezto and Vundle!

    sh -c "`curl -fsSL https://raw.githubusercontent.com/git4sroy/dotfiles/master/install.sh`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/git4sroy/dotfiles/master/install.sh`" -s ask
```
...
* If you don't want to use solarized terminal, then make sure you do this:
      ...
      let g:ohmy_yadr_using_unsolarized_terminal = 1
      # in ~/.vimrc.before

* If you want to use an alternate colorcheme like Gruvbox, then in your `~/.vimrc.after` do:

      let g:ohmy_yadr_disable_solarized_enhancements = 1
...
Read on to learn what OHMY-YADR provides!
...
[![Bitdeli Badge](https://d2weczhvl823v0.cloudfront.net/git4sroy/dotfiles/trend.png)](https://bitdeli.com/free "Bitdeli Badge")
